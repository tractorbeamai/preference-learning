...
1. **Read the PR description template:**
   - First, check if `thoughts/pr_description.md` exists
   - If it doesn't exist, inform the user that their `humanlayer thoughts` setup is incomplete and they need to create a PR description template at `thoughts/pr_description.md`
